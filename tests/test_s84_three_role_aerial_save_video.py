...
def test_aerial_save_video_rejects_output_inside_checkout(tmp_path: Path) -> None:
...
def test_aerial_save_video_rejects_unqualified_evidence(tmp_path: Path) -> None:
    evidence = tmp_path / "evidence.json"
